  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={
          shouldReduceMotion || !sharedLayout
            ? { duration: 0 }
                    ...
                    >
                      ...
                      >
                        <AlbumPhoto
                          layoutId={
                            sharedLayout
                              ? designImageLayoutId(design.slug, image.name)
                              : undefined
                          }
                          src={image.src}
                          alt=""
