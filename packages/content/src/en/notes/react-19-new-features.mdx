...
React Compiler is a separate, stable, optional build-time optimizer. See [React Compiler Internals](/notes/react-compiler-internals) for its HIR-to-cache pipeline and current adoption guidance.
