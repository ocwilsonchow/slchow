...
This note follows [Evan's walkthrough](https://www.youtube.com/watch?v=DU8o-OTeoCc). The general queue pattern — outbox, idempotent consumers, backpressure, and broker choice — is [Message Queues in System Design](/notes/message-queues-in-system-design). This note is the log.
