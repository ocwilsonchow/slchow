...
Tenant isolation and SaaS boundary design are a different problem — see [Designing a Serverless Multi-Tenant SaaS Architecture on AWS](/notes/serverless-multi-tenant-saas-architecture) when that is the question.
