...
This note assumes a typed backend with **Hono**, **Better Auth** sessions, **Drizzle**, and **PostgreSQL**. That base stack is covered in [Building Backend APIs with Hono, Drizzle and Zod OpenAPI](/notes/how-i-build-backend-apis). Here the focus is **tenant isolation**.
