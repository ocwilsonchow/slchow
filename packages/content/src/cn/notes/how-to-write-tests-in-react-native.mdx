...
完整 condition matrix 见 [如何改善 Mobile Development 的 User Experience](/notes/how-to-improve-user-experience-in-mobile-development)。这篇 note 的 device suite 专注 test design。
