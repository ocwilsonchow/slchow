...
这篇 note 假设 typed stack 见 [用 Hono、Drizzle、Zod OpenAPI 与 SST 打造 Backend APIs](/notes/_backend-apis-hono-sst)。这里聚焦 **tenant isolation**。
...
- Deploy、OpenAPI 与 Lambda 细节留在 [Backend APIs 笔记](/notes/_backend-apis-hono-sst)；这篇 note 只谈 isolation contract。
