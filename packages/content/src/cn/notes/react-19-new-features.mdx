...
React Compiler 是一项分开的、stable、optional build-time optimizer。它从 HIR 到 cache 的 pipeline 与当前 adoption guidance，见 [React Compiler Internals](/notes/react-compiler-internals)。
