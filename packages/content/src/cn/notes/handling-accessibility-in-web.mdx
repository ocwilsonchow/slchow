...
这篇 note 依 [Kyle 的 walkthrough](https://www.youtube.com/watch?v=Y7nhXvJ7yH8)。用 role 与 name 操作 controls 的 tests 见 [Frontend Engineering 中的 Test-Driven Development](/notes/test-driven-development-in-frontend)。Preview gate 的 automated checks 见 [React 的 Frontend CI/CD](/notes/frontend-ci-cd-for-react)。Native host 上的 VoiceOver 与 TalkBack 属于 [如何改善 Mobile Development 的 User Experience](/notes/how-to-improve-user-experience-in-mobile-development)。这篇是 web surface。
