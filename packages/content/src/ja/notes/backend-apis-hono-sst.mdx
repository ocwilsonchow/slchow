...
Backend API には request から database までの短い経路が必要であり、**validation**、**documentation**、**infrastructure** は同じコードから生まれる。この stack は **Hono**、**Better Auth**、**Drizzle**、**PostgreSQL**、**Zod OpenAPI**、**Scalar**、そして **AWS Lambda** または **ECS Fargate** 上の **SST** である。
