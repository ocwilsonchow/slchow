...
- Hono handler 是從 context 到 response 的 function。Nest 風格的 controller classes 屬於另一套 stack。[用 Hono 打造 Backend APIs](/notes/backend-apis-hono-sst) 把 routes 保持為 functions。
