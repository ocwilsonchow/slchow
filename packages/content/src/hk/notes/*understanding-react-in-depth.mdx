...
Runtime 決定一個 Fiber 能否 bail out。[React Compiler Internals](/notes/react-compiler-internals) 是 build-time 那一半：HIR、effects 與 reactive scopes 如何自動產生更細的 cache boundaries。
