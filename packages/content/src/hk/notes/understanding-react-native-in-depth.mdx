...
- **React Native 不是 WebView。** WebView 是應用裡的 browser origin。Fabric mount platform views。混用兩者是 security boundary，見 [Frontend Security in Next.js and React Native](/notes/frontend-security-nextjs-react-native)。
