...
完整 condition matrix 見 [如何改善 Mobile Development 的 User Experience](/notes/how-to-improve-user-experience-in-mobile-development)。這篇 note 的 device suite 專注 test design。
