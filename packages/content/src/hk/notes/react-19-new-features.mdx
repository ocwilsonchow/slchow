...
React Compiler 是一項分開的、stable、optional build-time optimizer。它從 HIR 到 cache 的 pipeline 與當前 adoption guidance，見 [React Compiler Internals](/notes/react-compiler-internals)。
